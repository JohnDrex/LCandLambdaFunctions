...
#list2 = [len(x) for x in words if 'the' not in x]
print(word_lengths)
...
new_range1 = [x for x in range(1000) if '4' in str(x)]
print(new_range1)
...
print("The word 'the' appears ", result, " times in the file")
